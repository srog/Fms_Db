...
GO
PRINT N'Altering [dbo].[sp_GetAllTeams]...';


GO
ALTER PROCEDURE [dbo].[sp_GetAllTeams]

AS
	SELECT [Id], [Name], [Division] FROM [Team]
RETURN 0
GO
...
AS
	SELECT [Id], [Name], [Age], [Rating], [Position] FROM [Player]
RETURN 0
GO
